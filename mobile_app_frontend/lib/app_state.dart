...
final List<Audiobook> dummyStoreAudiobooks = [
  Audiobook(
    ...
    price: 12.99,
    sampleUrl: 'https://www.archive.org/download/moby_dick_librivox/mobydick_001_melville.mp3',
    audioUrl: 'https://www.archive.org/download/moby_dick_librivox/mobydick_001_melville.mp3',
  ...
  Audiobook(
    ...
    price: 11.99,
    sampleUrl: 'https://www.archive.org/download/pride_prejudice_librivox/prideandprejudice_01_austen.mp3',
    audioUrl: 'https://www.archive.org/download/pride_prejudice_librivox/prideandprejudice_01_austen.mp3',
  ...
  Audiobook(
    ...
    price: 13.49,
    sampleUrl: 'https://www.archive.org/download/greatgatsby_202110_librivox/greatgatsby_01_fitzgerald.mp3',
    audioUrl: 'https://www.archive.org/download/greatgatsby_202110_librivox/greatgatsby_01_fitzgerald.mp3',
  ...
  Audiobook(
    ...
    price: 10.99,
    sampleUrl: 'https://www.archive.org/download/frankenstein_librivox/frankenstein_01_shelley.mp3',
    audioUrl: 'https://www.archive.org/download/frankenstein_librivox/frankenstein_01_shelley.mp3',
  ...
  Audiobook(
    ...
    price: 9.99,
    sampleUrl: 'https://www.archive.org/download/dracula_librivox/dracula_01_stoker.mp3',
  ...
  Audiobook(
    ...
    price: 10.99,
    sampleUrl: 'https://www.archive.org/download/adventures_sherlock_holmes/adventures_01_doyle.mp3',
    audioUrl: 'https://www.archive.org/download/adventures_sherlock_holmes/adventures_01_doyle.mp3',
  ...
  Audiobook(
    ...
    price: 8.89,
    sampleUrl: 'https://www.archive.org/download/treasure_island_librivox/treasureisland_01_stevenson.mp3',
  ...
  Audiobook(
    ...
    price: 7.99,
    sampleUrl: 'https://www.archive.org/download/artofwar_2013_librivox/artofwar_01_tzu.mp3',
    audioUrl: 'https://www.archive.org/download/artofwar_2013_librivox/artofwar_01_tzu.mp3',
  ...
  Audiobook(
    ...
    price: 12.49,
    sampleUrl: 'https://www.archive.org/download/jane_eyre_librivox/janeeyre_01_bront.mp3',
    audioUrl: 'https://www.archive.org/download/jane_eyre_librivox/janeeyre_01_bront.mp3',
